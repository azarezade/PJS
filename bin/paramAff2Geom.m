function q = paramAff2Geom(p)
% This function converts 6 affine parameters p to geometric parameters q
% affine transform is y=Ax+b that can be written in the form 
%           y1              p(3)   p(4)   p(1)           x1
%           y2      =       p(5)   p(6)   p(2)     *     x2
%           1                 0      0      1            1
% where
...
%                           p(2)    
%------ input --------
% p = affine parameters a 2x3 matrix
%------ output --------
% q = geometric parameters [center_x, center_y, scale, rotation, aspect_ratio, skew] 
