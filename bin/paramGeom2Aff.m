function q = paramGeom2Aff(p)
% This function converts geometric parameters p to 6 affine parameters q
%------ input --------
% p = geometric parameters [center_x, center_y, scale, rotation, aspect_ratio, skew] 
%------ output --------
% q = affine parameters a 2x3 matrix
