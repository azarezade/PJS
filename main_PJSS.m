...
%         paramNames=['_L',num2str(settings.SC_SOMP_Param.L),'_p',num2str(settings.objParam.patchWidth),'_',num2str(settings.pfParam.numsample),'p','_sigma',num2str(settings.objectModelLikelihoodSigma)];
        paramNames = [];
...
for f = 2:frameNum
    ...
    % Sparse Coding
	patchCoef = Coding( candidates, groupBuffer, patchDict, listGroups, patchIndex, [], settings);
